...
def create_plots(df_top1_final, save_path, frame_width=1, frame_height=1):
    ...
    #distinctipy not working, trying with matplotlib
    def generate_colors(num_colors):
        colors = plt.cm.tab20c(np.linspace(0, 1, num_colors))  # Utilisation de la palette tab20c
        return colors

    # Remplacer cette partie dans la fonction
    num_top1 = df_top1_final["top1"].nunique()
    colors = generate_colors(num_top1)
